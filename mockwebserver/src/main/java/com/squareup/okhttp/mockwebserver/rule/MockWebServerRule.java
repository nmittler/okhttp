...
import com.squareup.okhttp.mockwebserver.PortPicker;
 ...
 *
 * <p>This rule starts {@link MockWebServer} on a random port before your test runs, and shuts it
 * down after it completes.
 */
public class MockWebServerRule extends ExternalResource {
  ...
  private final int port = PortPicker.pickPort();
